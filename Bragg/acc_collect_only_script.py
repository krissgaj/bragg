...
def main(time_duration):
    ...
    # Run the additional script with the same time_duration
    subprocess.Popen(["python", "temperatura_script.py", str(time_duration)])
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python acc_collect_only.py <time_duration>")
        sys.exit(1)
    ...
    try:
        ...
        print("Invalid time_duration. Please provide a valid number.")
        sys.exit(1)